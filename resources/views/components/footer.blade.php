<footer class="relative  bg-azuloscuro dark:bg-dark pt-20 pb-10 lg:pt-[120px] lg:pb-20 -z-10">
    <div class="container mx-auto">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                <div class="w-full mb-10">
                    <a href="#" class="[grid-area:logo]">
                        <img src="{{'/images/1logo_completo.png'}}" class="w-50">
                    </a>
                    <p class="flex items-center text-sm font-medium text-dark dark:text-white">
                        ...
                        <span class="">+1 (240) 398-2051 </span>
                    </p>
                </div>
            </div>
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="/src/Termino y Condiciones.html"
                                class="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-white">
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="/src/Planes.html"
                                class="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-white">
                                Our Services
                            </a>
                        </li>
                        <li>
                            <a href="/src/SobreNosotros.html"
                                class="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-white">
                                Know Our Team
                            </a>
                        </li>
