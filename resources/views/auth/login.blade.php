            ...
            <div class="bg-white shadow-md rounded-md p-6">
                ...
                <form class="space-y-6" method="POST">
                    ...
                    <a href="{{route('auth.redirect.face')}}"
                        ...
                        <h1 class="px-4 py-3 w-5/6 text-center text-gray-600 font-bold">Login in with Facebook</h1>
                    </a>
                    <div>
                        <button type="submit"
                            class="flex w-full justify-center rounded-md border border-transparent bg-blue-300 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2">
                            Login
                        </button>
                    </div>
                </form>
